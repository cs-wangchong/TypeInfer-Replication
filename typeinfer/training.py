...
from typeinfer.model import GenerationModel, SimilarityModel, BiEncoderSimilarityModel
...
if __name__ == "__main__":
    ...
    SIMILARITY_DIR = f"models/similarity-model/{SIMILARITY_TYPE}-{EMBBEDING_MODE}"
    ...
    CLS = SimilarityModel if SIMILARITY_TYPE == 'singleton' else BiEncoderSimilarityModel
    sim_model = CLS(
        model_name="Salesforce/codet5-base",
        ckpt_path=None,
